  ...
  <div id="collapse-shipping" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group required">
        <label class="col-sm-2 control-label" for="input-payment-city"><?php echo "Kabupaten/Kota"; //echo $entry_city; ?></label>
        <div class="col-sm-10">
...
$('#button-quote').on('click', function() {
	$.ajax({
		...
		type: 'post',
		data: 'city=' + $('select[name=\'city\']').val() + '&kecamatan=' + $('select[name=\'kecamatan\']').val() + '&postcode=' + encodeURIComponent($('input[name=\'postcode\']').val()),
		dataType: 'json',
		beforeSend: function() {
