<div id="static-banners-<?php echo $module; ?>" class="static-banners-<?php echo $module_id; ?> box static-banners <?php echo $carousel ? 'journal-carousel' : ''; ?> <?php echo $carousel && $arrows === 'top' ? 'arrows-top' : ''; ?> <?php echo implode(' ', $disable_on_classes); ?> <?php echo isset($gutter_on_class) ? $gutter_on_class : ''; ?>" style="<?php echo isset($css) ? $css : ''; ?>">
    <div>
        <?php if ($title): ?>
