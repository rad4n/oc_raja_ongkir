            ...
            <div class="multi-modules-column <?php echo $column['classes']; ?>" style="<?php echo $module_spacing ? 'padding-right: ' . $module_spacing : ''; ?>">
                <?php $row_index = 0; foreach ($column['modules'] as $m): ?>
                    <?php if ($row_index === count($column['modules']) - 1): ?>
                        <div class="multi-modules-row <?php echo implode(' ', $m['class']); ?>" data-ratio="<?php echo $m['height']; ?>" style="height: calc(100% / <?php echo round(100 / $m['height']);?> - <?php echo $module_spacing?>);">
                            <?php echo $m['content']; ?>
                        </div>
                    <?php else: ?>
                        <div class="multi-modules-row <?php echo implode(' ', $m['class']); ?>" data-ratio="<?php echo $m['height']; ?>" style="height: calc(100% / <?php echo round(100 / $m['height']);?> - <?php echo $module_spacing?>); <?php echo $module_spacing ? 'margin-bottom: ' . $module_spacing : ''; ?>">
                            <?php echo $m['content']; ?>
                        </div>
                    <?php endif; ?>
