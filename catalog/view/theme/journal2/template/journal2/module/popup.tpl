<div id="journal-popup-<?php echo $module; ?>" class="journal-popup-<?php echo $module_id; ?> journal-popup journal-popup-<?php echo $type; ?> <?php echo implode(' ', $disable_on_classes); ?>" style="<?php echo implode('; ', $global_style); ?>; <?php echo $is_ajax? '' : 'display: none'; ?>">
    <?php if ($title): ?>
