    ...
    public function save($new_data = null) {
        ...
        if ($this->order_id) {
            ...
            if ($address_info) {
                ...
                $this->order_data['payment_country_id']     = Journal2Utils::getProperty($this->session->data, 'shipping_address.country_id', $this->config->get('config_country_id'));
                $this->order_data['payment_zone_id']        = Journal2Utils::getProperty($this->session->data, 'shipping_address.zone_id', $this->config->get('config_zone_id'));
                $this->order_data['payment_postcode']       = Journal2Utils::getProperty($this->session->data, 'shipping_address.postcode', '');
