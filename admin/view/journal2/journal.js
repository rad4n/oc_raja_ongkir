                    ...
                    $scope.edit = function() {
                        $modal.open({
                            ...
                            controller: function($scope, ngModel, $modalInstance) {
                                ...
                                $scope.font_sizes = _.map(_.range(4, 200), function(e) { return e === 4 ? '---' : e + 'px'; });
    ...
    module.factory('Rest', ['Ajax', 'Url', '$q', function(Ajax, Url, $q){
        return {
            ...
            duplicateModule: function(module_id) {
                return Ajax.post(Url.generateLink('index.php?route=module/journal2/rest/modules/duplicate', 'module_id=' + module_id, 'token=' + Journal2Config.token));
            },
