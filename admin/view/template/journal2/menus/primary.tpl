        ...
        <accordion-group data-ng-repeat="item in items" is-open="item.is_open">
            ...
            <accordion close-others="false">
                <accordion-group data-ng-repeat="subitem in item.items" is-open="subitem.is_open">
                    <accordion-heading>
                        <div class="accordion-bar bar-level-2">{{getItemName(subitem)}} <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeSubItem(item, $index)"><b></b>Remove</a></div>
                    </accordion-heading>
                    <ul class="module-create-options">
                        <li>
                            <span class="module-create-title">Icon</span>
