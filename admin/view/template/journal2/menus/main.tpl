...
<div class="module-body">
    ...
    <accordion close-others="close_others">
        ...
        <accordion-group data-ng-repeat="menu in items" is-open="menu.is_open" ng-init="$parentIndex = $index">
            <accordion-heading>
                <div class="accordion-bar bar-level-0"> Menu Item {{$index + 1}} <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeMenu($index)"><b></b>Remove</a> <a class="accordion-remove slide-remove" data-ng-click="duplicateMenu($index); $event.stopPropagation()"><b ></b>Duplicate</a></div>
            </accordion-heading>
            <ul class="module-create-options">
                <!-- menu type -->
                <li>
