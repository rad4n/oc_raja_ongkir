...
<div class="module-body footer-columns">
    ...
    <accordion close-others="close_others">
        ...
        <accordion-group data-ng-repeat="row in rows" is-open="row.is_open" ng-init="$parentIndex = $index">
            ...
            <accordion-heading>
                <div class="accordion-bar bar-level-0">Row {{$index + 1}} <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeRow($index)"><b ></b>Remove</a> <a class="accordion-remove slide-remove" data-ng-click="duplicateRow($index); $event.stopPropagation()"><b ></b>Duplicate</a></div>
            </accordion-heading>
            ...
            <accordion close-others="row.close_others" data-ng-show="row.type === 'columns'">
                ...
                <accordion-group data-ng-repeat="column in row.columns" is-open="column.is_open">
                    ...
                    <accordion-heading>
                        <div class="accordion-bar bar-level-1">Column {{$index + 1}} <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeColumn(row, $index)"><b ></b>Remove</a> <a class="accordion-remove slide-remove" data-ng-click="duplicateColumn($parentIndex, $index); $event.stopPropagation()"><b ></b>Duplicate</a></div>
                    </accordion-heading>
