...
<!--                    <span class="module-create-title">Diagonal Text Spacing <small>Top - Bottom</small></span>-->
<!--                    <span class="module-create-option">-->
<!--                            <j-opt-text data-ng-model="settings.out_of_stock_ribbon_top_space" class="journal-number-field"></j-opt-text> --->
<!--                            <j-opt-text data-ng-model="settings.out_of_stock_ribbon_bottom_space" class="journal-number-field"></j-opt-text>-->
<!--                        </span>-->
<!--                    <a href="#" target="_blank" class="journal-tip"> </a>-->
<!--                </li>-->
