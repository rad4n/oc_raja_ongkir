                            ...
                            <accordion-group is-open="false" data-ng-show="settings.product_page_gallery == '1'">
                                ...
                                <ul class="module-create-options">
                                    ...
                                    <li data-ng-hide="settings.pp_gallery_thumbs === 'off'">
                                        ...
                                        <j-opt-text data-ng-model="settings.pp_gallery_thumbs_height" class="journal-number-field"></j-opt-text> &nbsp; &nbsp; <span style="position: absolute">Image dimensions are declared in Opencart > Extensions > Themes > Edit > Images > Additional Product Image Size</span>
                                    </span>
                                        <a href="#" target="_blank" class="journal-tip"></a>
                                    </li>
                                    <li data-ng-hide="settings.pp_gallery_thumbs === 'off'">
